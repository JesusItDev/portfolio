...
export const socialNetworks = [
  {
    ...
    src: "https://www.linkedin.com/in/jemmarg/",
  },
  {
    id: 2,
    logo: <Github size={30} strokeWidth={1} />,
    src: "https://github.com/JesusItDev",
  },
];
...
export const dataAboutPage = [
  {
    ...
    description: `Create management communication plans and
    processes
    Analyze and develop procedures for management and
    technical duties.
    Maintain project time frames and status reports.
    Create and adjust pre-existing procedures to the client
    enviroment.
    Technical analysis of eventualities`,
    date: "Mar 2023 ",
  },
  {
    id: 2,
    title: "Web Developer",
    subtitle: "Business in Motion",
    description: `Design and development of Web Pages
    Front-End and Back-End Module Implementation
